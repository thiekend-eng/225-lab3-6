pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/thiekend'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/thiekend-eng/225-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('thiekend-225')                                                         //<------change this
    }
